...
const fr: Messages = {
  ...
  'home.subtitle':       'Ouvrez un fichier MIDI pour le visualiser, ou jouez en direct avec votre clavier, votre souris, ou un contrôleur MIDI.',
  'home.cta.openMidi':   'Ouvrir MIDI',
  'home.cta.playLive':   'Jouer en direct',
  'home.samples.label':  'ou explorez un exemple',
  'home.dropHint.html':  'Déposez un <code>.mid</code> n\'importe où · jouez avec <kbd>A</kbd><kbd>S</kbd><kbd>D</kbd>…',
  ...
  // ── Errors ─────────────────────────────────────────────────
  'error.midi.parseFailed':     "Impossible de lire ce fichier — assurez-vous qu'il s'agit d'un MIDI valide.",
  'error.sample.fetchFailed':   'Impossible de charger cet exemple — vérifiez votre connexion et réessayez.',
  ...
  'error.practice.fileOnly':    "Le mode entraînement n'est disponible que pendant la lecture d'un fichier MIDI.",
  ...
  'postSession.openInFile.sub':        'Visualisez-la comme un piano roll défilant — prête à être exportée en MP4.',
  ...
  'toast.recording.empty':   "Rien d'enregistré — jouez quelques notes pendant que Record est activé.",
