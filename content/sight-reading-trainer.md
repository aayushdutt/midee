---
title: Free sight-reading trainer for piano
description: Train piano sight reading in your browser with scrolling staff notes, clef options, tempo control, accuracy, streaks, weak-note practice, and MIDI input.
path: /sight-reading-trainer/
type: page
modified: 2026-05-07
---
...
If you came from a focused browser trainer like sightread.dev, midee's main difference is breadth: sight reading lives beside play-along wait mode, interval training, live mode, looping, MIDI playback, and MP4 export. See the [midee vs sightread.dev comparison](/vs/sightread-dev/) for the fuller breakdown.
...
**Can I train sight reading online for free?**
Yes. midee includes a browser-based sight-reading exercise.

**Do I need a MIDI keyboard?**
A MIDI controller is best, but computer keyboard input also works.

**Does it support bass clef?**
Yes. The trainer includes clef controls for treble, bass, and both.

**Does it track mistakes?**
Yes. The session summary includes accuracy, streaks, missed notes, XP, and weak-note practice.

**Is this the same as Synthesia?**
No. Synthesia-style falling notes show you what to play visually. Sight reading trains staff notation recognition directly.

**Can beginners use it?**
Yes. It starts with simple pitch pools such as landmark notes and C major ranges.
